    ...
    <div className='w-full h-screen duration-200'
     ...
     >
      <div className='fixed flex flex-wrap justify-center bottom-12 inset-x-0 px-2'>
        <div className='flex flex-wrap justify-center gap-5 shadow-lg bg-gray-100 px-3 py-2 rounded-full'>
          ...
          <button onClick={()=>setColor("olive")} className='outline-none px-4 rounded-full' style={{backgroundColor:"olive"}}>Olive</button>
